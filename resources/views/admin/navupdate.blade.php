        ...
        <div class="page-content">
            <div class="row">
                ...
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" role="form" action="{{url('admin/navupdate_do/'.$row->id)}}" method="post">
                        {{csrf_field()}}
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 导航名称 </label>

                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" placeholder="导航名称" class="col-xs-10 col-sm-5" name="nav_name" value="{{$row->nav_name}}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 导航简介 </label>

                            <div class="col-sm-9">
                                <textarea cols="30" rows="10" name="nav_desc" >{{$row->nav_desc}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 导航链接 </label>

                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" placeholder="导航链接" class="col-xs-10 col-sm-5" name="nav_link" value="{{$row->nav_link}}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 导航排序 </label>

                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" placeholder="导航排序" class="col-xs-10 col-sm-5" name="nav_sort" value="{{$row->nav_sort}}"/>
                            </div>
                        </div>
