...
<div class="main-content">
					...
					<div class="page-content">
							<div class="row">
									...
									<form class="form-horizontal" role="form" action="{{url('admin/activityadd_do')}}" method="post">
									{{csrf_field()}}
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 活动名称 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="活动名称" class="col-xs-10 col-sm-5" name="name"/>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2" placeholder="活动类型" class="col-xs-10 col-sm-5" name="type"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea cols="30" rows="10" name="rules"></textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
													<div class="input-group" style=" width:150px;">
														<input class="form-control date-picker" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" name="begin_time"/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
													<div class="input-group" style=" width:150px;">
														<input class="form-control date-picker" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" name="end_time"/>
														<span class="input-group-addon">
															<i class="icon-calendar bigger-110"></i>
														</span>
													</div>
